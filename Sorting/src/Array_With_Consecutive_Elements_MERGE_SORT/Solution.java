package Array_With_Consecutive_Elements_MERGE_SORT;
...
public class Solution {
    ...
    public static int solve(int[] A) {
        int n = A.length;
        // Arrays.sort(A);
        //without in build sorting //use of merge sort
        int start=0;
        int end=n-1;
